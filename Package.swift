...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AsyncDisplayKitBinary",
            url: "https://github.com/3a4oT/Texture/releases/download/4.0.2/Texture.xcframework.zip",
            checksum: "3d3519d2fe5d2f04057501e25eb6e482883effb0bc50119c754d5d37cd6c6497"
        ),
