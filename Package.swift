...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AsyncDisplayKitBinary",
            url: "https://github.com/3a4oT/Texture/releases/download/4.0.1/Texture.xcframework.zip",
            checksum: "78089facb76ab8eb2fbbd24657c0ef8c3385f610dc7acee200277759952e7d94"
        ),
